...
void Convert_Labels(const char* aInName)
{
    ...
    std::ofstream lOut(HMI::LABELS_TXT, std::ios::binary);

    lOut << END_OF_LINE;
    lOut << "# This file has been generated by KMS-PLC - EBPro_Convert_Label.exe" << END_OF_LINE;
    lOut << "# from the data read from " << aInName << END_OF_LINE;
    lOut << END_OF_LINE;
